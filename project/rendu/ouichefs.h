...
/*
 * Depuis que la taille d'un bloc est codé sur 12 bits,
 * on ne peut pas encoder plus que OUICHEFS_BLOCK_SIZE - 1.
 * Ceci permet d'éviter un dépassement qu'on ne pourrait pas gérer.
 */
#define OUICHEFS_MAX_BLOCK_SIZE (OUICHEFS_BLOCK_SIZE - 1)

#define OUICHEFS_MAX_FILESIZE (1 << 22) /* 4 MiB */
#define OUICHEFS_FILENAME_LEN 28
#define OUICHEFS_MAX_SUBFILES 128
#define OUICHEFS_MAX_BLOCKS_PER_FILE 1024
